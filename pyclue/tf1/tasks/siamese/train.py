...
from pyclue.tf1.tasks.siamese.inputs import SiameseProcessorFile
from pyclue.tf1.tasks.siamese.inputs import SiameseInputFnFile
from pyclue.tf1.tasks.siamese.models import PretrainedSiameseModel
from pyclue.tf1.tasks.siamese.models import TraditionalSiameseModel
...
class SiameseTrainer(object):
    ...
    def build_model(self, nlu_name=None, from_pretrained=True, nlu_model_type=None,
        ...
        if self.from_pretrained:
            self.siamese_model = PretrainedSiameseModel(
                nlu_name=nlu_name,
            ...
            self.siamese_model = TraditionalSiameseModel(
                nlu_name=nlu_name,
                nlu_model_type=nlu_model_type,
                nlu_vocab_file=nlu_vocab_file,
                nlu_config_file=nlu_config_file,
                nlu_init_checkpoint_file=nlu_init_checkpoint_file,
                downstream_name=downstream_name)
        self.nlu_name = self.siamese_model.nlu_name
        self.nlu_model_type = self.siamese_model.nlu_model_type
        self.nlu_vocab_file = self.siamese_model.nlu_vocab_file
        self.nlu_init_checkpoint_file = self.siamese_model.nlu_init_checkpoint_file
        self.nlu_config = self.siamese_model.nlu_config
    ...
    def _load_processor(self):
        self.processor = SiameseProcessorFile(
    ...
    def _load_input_fn(self):
        self.input_fn_builder = SiameseInputFnFile(
    ...
    def _load_model_fn(self):
        ...
        def model_fn(features, labels, mode, params):
            ...
            pooled_output_1, pooled_output_2, cos_sim = self.siamese_model(
    ...
    def predict(self, texts):
        ...
        return [{
            ...
            zip(texts, cos_sims, predictions, probabilities)]
