...
class MultiClassModel(object):
    ...
    def _build_pretrained(self, is_training, input_ids, input_mask, segment_ids,
        ...
        self.pretrained_model = self.PretrainedModel(
        ...
        pooled_output = self.pretrained_model.get_pooled_output()
        sequence_output = self.pretrained_model.get_sequence_output()
